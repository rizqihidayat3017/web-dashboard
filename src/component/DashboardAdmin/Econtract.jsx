...
function Econtract() {
  ...
  return (
    <div className="container mx-auto p-4 bg-white shadow-lg print:mb-24">
      <div
      ...
      >
        <div>
          {/* Judul */}
          <h1 className="font-bold text-center font-serif text-base pt-10">
        ...
        {/* Konten */}
        <div className="px-10 mt-10 text-justify">
          <p>
        ...
        <div className="mt-3 px-20 text-justify">
          <p>
            <span className="font-bold">I. PT BISI International, Tbk.</span>,
            sebuah perusahaan terbuka yang didirikan dan melakukan kegiatan
            usaha berdasarkan pada Hukum Negara Republik Indonesia, berkedudukan
            dan beralamat di Jalan Raya Surabaya-Mojokerto Km 19, Desa
            Beringinbendo, Kecamatan Taman, Kabupaten Sidoarjo, dalam hal ini
            diwakili secara sah oleh .......................... yang bertindak
            selaku Kuasa berdasarkan Surat Kuasa tertanggal ................,
            dari dan oleh karenanya untuk dan atas nama PT BISI International,
            Tbk. selanjutnya disebut “BISI.”
          </p>
          <p className="pt-3">
          ...
          <p className="pt-3">
            ...
            berdasarkan pada Hukum Negara Republik Indonesia, beralamat di Jalan
            Ancol Barat VIII/ 1, Kelurahan Ancol, Kecamatan Pademangan, Jakarta
            Utara, dalam hal ini diwakili secara sah oleh………………. yang bertindak
            selaku Kuasa berdasarkan Surat Kuasa tertanggal ................,
            dari dan oleh karenanya untuk dan atas nama PT Charoen Pokphand
            Indonesia, Tbk. …………………., untuk selanjutnya disebut sebagai{" "}
            <span className="font-bold">“CPI.”</span>
          </p>
        </div>
        <div className="pl-10 pr-20 mt-3 text-justify">
          <p>
          ...
          <p>
            ...
            bersepakat, membuat kerjasama usaha pertanian. Petani akan menanam
            jagung dan BISI akan memasok Sarana Produksi Pertanian (Saprotan)
            serta memberikan bimbingan sampai jagung siap dijual.
          </p>
          <p>
          ...
          <p className="pt-3">
            ...
            dengan BISI sebagai pemasok Saprotan, Petani mengikatkan diri untuk
          ...
          <p>
            1.5. <span></span>Kerjasama usaha pertanian dan pengikatan jual beli
            jagung berdasarkan Perjanjian ini berlaku untuk jangka waktu
            sebagaimana ditetapkan dalam{" "}
            <span className="font-bold">Lampiran I</span> (“Jangka Waktu
            Kerjasama dan Pengikatan Jual Beli”
          </p>
          <p className="pt-3 font-bold">Pasal 2</p>
          ...
          <div className="pl-10">
            ...
            <p>
              e. memberikan bimbingan tata cara panen, penggunaan teknologi, dan
              pengelolaan pascapanen;
            </p>
            <p>
              f. memberikan solusi bagi masalah pemasaran hasil-hasil budidaya;
            </p>
            <p>
              ...
              memudahkan CPI melakukan pemotongan pada saat pembayaran pembelian
              jagung.
            </p>
            {/* PAGE 2 */}
            ...
            <p>
              ...
              budidaya pertanian untuk digunakan dalam kerjasama usaha pertanian
            ...
            <p>
              e. melakukan budidaya menurut tata cara budidaya yang baik sesuai
            ...
            <p>
              ...
              apabila CPI ingin mengetahui kondisi jagung yang ditanam di lahan
              yang telah ditentukan sampai dengan saatnya panen;
            </p>
            <p>
            ...
            <p>
              a. Membeli jagung yang ditanam pada lahan yang beralamat di lokasi
              sebagaimana disebutkan dalam{" "}
              <span className="font-bold">Lampiran II</span> mengenai Data
              Lokasi dan Lahan, sesuai dengan spesifikasi mutu, harga pada saat
              penyerahan dan tabel rafaksi yang diterbitkan oleh CPI dari waktu
              ke waktu;
            </p>
            <p>
          ...
          <p>
            3.1. Untuk kerjasama usaha pertanian ini, Petani menyediakan lahan
            budidaya yang berlokasi di: .......................................
          </p>
          <p>
            3.2. Pendataan lahan akan dilakukan dengan menggunakan aplikasi dan
            divalidasi dengan <span className="italic">polygon geotagging</span>
            . Data lahan, titik-titik koordinat, dan luas lahan hasil pendataan
            dinyatakan dalam <span className="font-bold">Lampiran II</span>{" "}
          ...
          <p>
            ...
            sengketa kepemilikan atau pemanfaatannya, dan dapat digunakan dengan
            aman untuk kerjasama berdasarkan Perjanjian ini.
          </p>
          <p>
            3.4. Sehubungan dengan pernyataan dan jaminan dalam Ayat 3.3, Petani
            berjanji akan menunjukkan, kepada BISI dan CPI, surat pernyataan
            asli dari setiap pemilik lahan budidaya, dalam substansi dan format
            sesuai <span className="font-bold">Lampiran III</span> (Format Surat
            Pernyataan).
          </p>
          <p className="pt-3 font-bold">Pasal 4</p>
          <p className="underline">Pengadaan Saprotan Dan Penjualan Jagung</p>
          <p>
            4.1. Pengadaan Saprotan oleh Petani dilakukan setiap awal
            periode/musim tanam sesuai dengan kebutuhan atau standar yang
            tercantum pada <span className="font-bold">Lampiran V</span> (Teknik
            Budidaya Jagung Hibrida BISI).
          </p>
          <p>
            4.2. Petani akan membeli Saprotan dari BISI, dan BISI akan menjual
          ...
          <p>
            4.5. Jatuh tempo pembayaran pembelian Saprotan oleh Petani adalah
            pada setiap akhir periode/musim tanam, yaitu ketika hasil budidaya
            dijual.
          </p>
          <p>
            4.6. Atas jagung hasil budidaya Petani yang dijual kepada CPI, maka
            Petani dengan ini memberi kuasa kepada CPI untuk dan atas nama
            Petani memotong atau dengan cara lain menggunakan sebagian uang dari
            penjualan hasil budidaya, sebesar jumlah hutang Petani kepada BISI,
            untuk melunasi hutang tersebut.
          </p>
          <p>
            4.7. Untuk tiap-tiap pembayaran hutang oleh Petani melalui CPI, BISI
            memberikan kwitansi atau tanda terima yang sah kepada Petani
          </p>
          <div>
            <p className="font-bold pt-3">Pasal 5</p>
            <p className="underline">Spesifikasi dan Standar Mutu Saprotan</p>
            <p>
          ...
          <p>
            6.1. Penyerahan Saprotan dilakukan di lahan budidaya yang dinyatakan
            dalam Pasal 3 Perjanjian ini.
          </p>
          <p>
            6.2. Pada saat penyerahan Saprotan, Para Pihak menandatangani
            Delivery Order (surat jalan) yang berlaku sebagai bukti serah terima
            Saprotan.
          </p>
          <p>
            6.3. Penyerahan Saprotan menandai peralihan kepemilikan dan tanggung
        ...
        <div className="pl-10 pr-20 mt-10 text-justify">
          <p>LAMPIRAN II</p>
          <p>
            Perjanjian Kerjasama Usaha Pertanian Dan Pengikatan Jual Beli Jagung
          </p>
          <p>Nomor: …………………………………..</p>
              ...
              <table className="table-auto border-collapse border border-gray-400">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-400 p-4">-78632876874</td>
          ...
          <p className="pt-3">
            ...
            menggunakan aplikasi dan telah divalidasi dengan menggunakan sistem{" "}
            <span className="italic">polygon geotagging</span>
          </p>
        </div>
              ...
              <table className="table-auto border-collapse border border-gray-400">
                <tbody>
                  <tr>
                    ...
                    <td className="border border-gray-400 p-4">Kemasan</td>
                    <td className="border border-gray-400 p-4">
        ...
        <div className="pl-10 pr-20 mt-10 text-justify">
          <div>
            ...
            <div className="pl-10">
              <p>1. Kode varietas : ………….</p>
              <p>2. 2. Kebutuhan benih : ………</p>
              <p>
                3. Jarak Tanam : 75 x 25 cm dengan jumlah benih 1 (satu) atau 2
                (dua) biji per lubang
              </p>
            ...
            <div className="overflow-x-auto items-start">
              <table className="table-auto border-collapse border border-gray-400">
                <tbody>
                  <tr>
                    <td className="border border-gray-400 p-4">Jenis Pupuk</td>
                    <td className="border border-gray-400 p-4">
                      Bersamaan Tanam
                    </td>
                    <td className="border border-gray-400 p-4">10-15 HST</td>
                    <td className="border border-gray-400 p-4">25-30 HST</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-400 p-4">NPK</td>
                    <td className="border border-gray-400 p-4">200 kg/ha</td>
                    <td className="border border-gray-400 p-4">-</td>
                    <td className="border border-gray-400 p-4">-</td>
                  </tr>
                  <tr>
            ...
            <div>
              <p className="pl-10">5. Penyemprotan Paket Anti Gulma (PAG)</p>
              <div className="overflow-x-auto items-start">
                <table className="table-auto border-collapse border border-gray-400">
                  <tbody>
                    <tr>
            ...
            <div>
              <p className="pl-10">6. Pupuk daun (jika diperlukan)</p>
              <div className="overflow-x-auto items-start">
                <table className="table-auto border-collapse border border-gray-400">
                  <tbody>
                    <tr>
            ...
            <div>
              <p className="pl-10">7. Insektisida (jika diperlukan)</p>
              <div className="overflow-x-auto items-start">
                <table className="table-auto border-collapse border border-gray-400">
                  <tbody>
                    <tr>
            ...
            <div>
              <p className="pl-10">8. Penyemprotan Boom Jagung</p>
              <div className="overflow-x-auto items-start">
                <table className="table-auto border-collapse border border-gray-400">
                  <tbody>
                    <tr>
            ...
            <div>
              <p className="pl-10">9. Jadwal kegiatan</p>
              <div className="overflow-x-auto items-start">
