...
function Econtract() {
  ...
  return (
    <div ref={targetRef}>
      ...
      <h2
        style={{ paddingLeft: "81pt", textIndent: "0pt", textAlign: "center" }}
      >
        DAN
      </h2>
      <p
        className="s1"
        style={{ paddingLeft: "136pt", textIndent: "0pt", textAlign: "center" }}
      >
      ...
      <p style={{ paddingLeft: "11pt", textIndent: "0pt", textAlign: "left" }}>
        ...
        “Perjanjian”) ini dibuat pada hari ini, ............., tanggal , oleh
        dan antara :
      </p>
      <ol id="l1">
        <li data-list-text="I.">
        ...
        <li data-list-text="II.">
          ...
          >
            di …………….., Provinsi……….., Pemegang Kartu Tanda Penduduk dengan
            Nomor Induk Kependudukan (NIK) : ……………… dalam hal ini bertindak
            untuk dan atas nama diri sendiri, Untuk selanjutnya disebut sebagai{" "}
            <b>“Petani.”</b>
          </p>
          <p style={{ textIndent: "0pt", textAlign: "left" }}>
            <br />
        ...
        <li data-list-text="III.">
          ...
          >
            ...
            <span className="p">
              ...
              beralamat di Jalan Ancol Barat VIII/ 1, Kelurahan Ancol, Kecamatan
              Pademangan, Jakarta Utara, dalam hal ini diwakili secara sah
              oleh………………. yang bertindak selaku Kuasa berdasarkan Surat Kuasa
              tertanggal ................, dari dan oleh karenanya untuk dan
              atas nama PT Charoen Pokphand Indonesia, Tbk. …………………., untuk
      ...
      >
        BISI, Petani dan CPI selanjutnya secara bersama-sama disebut sebagai{" "}
        <b>“Para Pihak”</b>. Para Pihak dengan ini terlebih dahulu menerangkan
      ...
      <ul id="l2">
        <li data-list-text="-">
          ...
          >
            Bahwa BISI adalah sebuah perusahaan yang bergerak dalam bidang usaha
            pertanian, baik yang dilakukan sendiri maupun melalui kerjasama
            usaha dengan pihak/pelaku usaha lain, serta bidang usaha
            perdagangan, yang meliputi perdagangan sarana produksi pertanian dan
        ...
        <li data-list-text="-">
          ...
          >
            ...
            menjalankan kegiatan usaha budidaya pertanian, baik secara langsung
            maupun melalui kelompok tani di bawah koordinasi Petani, dan dalam
            hal ini mengadakan kerjasama usaha budidaya pertanian dengan BISI,
            terutama dalam hal pengadaan sarana produksi pertanian, pelaksanaan
            budidaya pertanian serta penanganan pasca panen, seperti pengolahan
            dan pemasaran hasil-hasil pertanian.
          </p>
        </li>
        <li data-list-text="-">
          <p
          ...
          >
            Bahwa CPI adalah sebuah perusahaan yang salah satu usahanya bergerak
            di dalam bidang industri makanan ternak yang menggunakan jagung
        ...
        <li data-list-text="-">
          ...
          >
            Bahwa untuk saling mendukung dan bersinergi dalam memajukan usaha
            pertanian guna meningkatkan efisiensi, kualitas hasil budidaya dan
            daya saing di bidang usaha pertanian, BISI dan Petani telah
            bersepakat, membuat kerjasama usaha pertanian. Petani akan
          </p>
          <p
            style={{
              paddingTop: "3pt",
      ...
      >
        Berdasarkan latar belakang dan pertimbangan-pertimbangan tersebut di
        atas dan dengan dilandasi prinsip-prinsip: saling memerlukan, saling
        mempercayai, saling memperkuat dan saling menguntungkan, Para Pihak
        secara sadar, bebas dan tanpa paksaan dan/atau tekanan dari Pihak
        manapun, dengan ini setuju satu sama lain untuk bekerjasama dalam hal
        jual beli jagung, oleh karenanya sepakat membuat Perjanjian Kerjasama
        Usaha Pertanian dan Pengikatan Jual Beli Jagung ini, dengan
      ...
      >
        Kesepakatan Kerjasama Usaha Pertanian dan Pengikatan Jual Beli Jagung
      </p>
      <p style={{ textIndent: "0pt", textAlign: "left" }}>
        <br />
      </p>
      <ol id="l3">
        <ol id="l4">
          <li data-list-text="1.1.">
            ...
            >
              Para Pihak dengan ini bersepakat dan saling mengikatkan diri dalam
              hubungan kerjasama usaha pertanian dan jual beli jagung, dengan
              BISI sebagai pemasok Saprotan, Petani mengikatkan diri untuk
              menjual jagung kepada CPI dan CPI mengikatkan diri untuk membeli
              jagung dari Petani.
            </p>
          </li>
          <li data-list-text="1.2.">
            ...
            >
              BISI akan memasok (menjual) sarana produksi pertanian (Saprotan)
              kepada Petani secara kredit tanpa bunga, memberikan bimbingan
              teknis budidaya pertanian dan manajemen usaha, mendorong
          ...
          <li data-list-text="1.3.">
            ...
            >
              BISI akan menerima pembayaran dari Petani melalui CPI berdasarkan
              kuasa dari Petani dengan memotong sejumlah uang untuk dibayarkan
              kepada BISI terkait pembelian Sarana Produksi Pertanian (Saprotan)
              oleh Petani.
            </p>
          </li>
          <li data-list-text="1.4.">
            ...
            >
              Sehubungan dengan pasal 1.3 di atas, pada saat CPI akan melakukan
              pembayaran kepada Petani, BISI akan memberikan informasi kepada
              CPI mengenai sejumlah uang yang akan dipotong untuk pembayaran
          ...
          <li data-list-text="1.5.">
            ...
            >
              ...
              berdasarkan Perjanjian ini berlaku untuk jangka waktu sebagaimana
              ditetapkan dalam <b>Lampiran I </b>(“Jangka Waktu Kerjasama dan
      ...
      <p
        className="s2"
        style={{ paddingLeft: "11pt", textIndent: "0pt", textAlign: "justify" }}
      >
          ...
          <li data-list-text="2.1.">
            ...
            <ol id="l7">
              <li data-list-text="a.">
                ...
                >
                  memasok (menjual) Saprotan, berupa benih, pestisida, ZPT, dan
                  lain-lain, seperti, apabila diperlukan, peralatan pertanian,
                  kepada Petani menurut syarat-syarat dan ketentuan-ketentuan
                  yang akan disepakati pada waktunya;
                </p>
              </li>
              <li data-list-text="b.">
                <p
              ...
              <li data-list-text="d.">
                ...
                >
                  memastikan terlaksananya tata cara budidaya yang baik bagi
              ...
              <li data-list-text="e.">
                ...
                >
                  memberikan bimbingan tata cara panen, penggunaan teknologi,
              ...
              <li data-list-text="f.">
                ...
                >
                  memberikan solusi bagi masalah pemasaran hasil-hasil budidaya;
                </p>
              </li>
              <li data-list-text="g.">
                <p
                ...
                >
                  memberikan informasi kepada CPI mengenai sejumlah uang yang
          ...
          <li data-list-text="2.2.">
            ...
            <ol id="l8">
              <li data-list-text="a.">
                ...
                >
                  dengan biaya sendiri atau kelompok tani, menyediakan lahan
              ...
              <li data-list-text="e.">
                ...
                >
                  melakukan budidaya menurut tata cara budidaya yang baik sesuai
                  petunjuk-petunjuk BISI;
                </p>
              </li>
              <li data-list-text="f.">
                <p
              ...
              <li data-list-text="i.">
                ...
                >
                  memberikan ijin kepada CPI untuk turut melakukan peninjauan
              ...
              <li data-list-text="j.">
                ...
                >
                  menjual jagung hasil panen dari lahan yang telah ditentukan
                  (sesuai <b>Lampiran II</b>) kepada CPI.
                </p>
              </li>
            </ol>
          </li>
            ...
            <ol id="l11">
              <li data-list-text="a.">
                ...
                >
                  ...
                  mengenai Data Lokasi dan Lahan, sesuai dengan spesifikasi
                  mutu, harga pada saat penyerahan dan tabel rafaksi yang
                  diterbitkan oleh CPI dari waktu ke waktu;
                </p>
              </li>
              <li data-list-text="b.">
                <p
      ...
      <ol id="l12">
        <ol id="l13">
          <li data-list-text="3.1.">
            ...
            >
              Untuk kerjasama usaha pertanian ini, Petani menyediakan lahan
              budidaya yang berlokasi di:
              .......................................
            </p>
          </li>
          <li data-list-text="3.2.">
            ...
            >
              Pendataan lahan akan dilakukan dengan menggunakan aplikasi dan
              divalidasi dengan <i>polygon geotagging</i>. Data lahan,
              titik-titik koordinat, dan luas lahan hasil pendataan dinyatakan
              dalam <b>Lampiran II </b>(Data Lokasi dan Lahan).
            </p>
          </li>
          <li data-list-text="3.3.">
            ...
            >
              Petani menyatakan dan menjamin bahwa lahan yang digunakan adalah
              milik Petani atau pemilik lahan budidaya dalam koordinasi Petani,
              dan tidak ada pihak lain yang turut memiliki lahan, atau turut
              berhak atas penggunaan lahan, dan bahwa lahan tidak dalam sengketa
              kepemilikan atau pemanfaatannya, dan dapat digunakan dengan aman
              untuk kerjasama berdasarkan Perjanjian ini.
            </p>
          </li>
          <li data-list-text="3.4.">
            ...
            >
              Sehubungan dengan pernyataan dan jaminan dalam Ayat 3.3, Petani
              berjanji akan menunjukkan, kepada BISI dan CPI, surat pernyataan
              asli dari setiap pemilik lahan budidaya, dalam substansi dan
              format sesuai <b>Lampiran III </b>(Format Surat Pernyataan).
            </p>
          </li>
        </ol>
      </ol>
      ...
      <ol id="l14">
        <ol id="l15">
          <li data-list-text="4.1.">
            ...
            >
              Pengadaan Saprotan oleh Petani dilakukan setiap awal periode/musim
              tanam sesuai dengan kebutuhan atau standar yang tercantum pada{" "}
          ...
          <li data-list-text="4.2.">
            ...
            >
              Petani akan membeli Saprotan dari BISI, dan BISI akan menjual
              Saprotan kepada Petani, selanjutnya jagung hasil budidaya Petani
              akan dijual kepada CPI.
            </p>
          </li>
          <li data-list-text="4.3.">
            ...
            >
              Jual beli Saprotan yang dimaksud dalam pasal ini dilakukan secara
              kredit tanpa bunga untuk jangka waktu satu periode tanam.
            </p>
          </li>
          ...
          <li data-list-text="4.5.">
            ...
            >
              Jatuh tempo pembayaran pembelian Saprotan oleh Petani adalah pada
              setiap akhir periode/musim tanam, yaitu ketika hasil budidaya
              dijual.
            </p>
          </li>
          <li data-list-text="4.6.">
            ...
            >
              Atas jagung hasil budidaya Petani yang dijual kepada CPI, maka
              Petani dengan ini memberi kuasa kepada CPI untuk dan atas nama
              Petani memotong atau dengan cara lain menggunakan sebagian uang
              dari penjualan hasil budidaya, sebesar jumlah hutang Petani kepada
              BISI, untuk melunasi hutang tersebut.
            </p>
          </li>
          <li data-list-text="4.7.">
            ...
            >
              Untuk tiap-tiap pembayaran hutang oleh Petani melalui CPI, BISI
              memberikan kwitansi atau tanda terima yang sah kepada Petani.
            </p>
          </li>
        </ol>
      </ol>
      ...
      <p style={{ paddingLeft: "11pt", textIndent: "0pt", textAlign: "left" }}>
        Saprotan yang dipasok oleh BISI kepada Petani dalam kerjasama usaha ini
        meliputi dan memenuhi standar mutu sebagai berikut :
      </p>
      <table
        ...
        <tbody>
          ...
          <tr style={{ height: "14pt" }}>
            ...
            >
              ...
              >
                - <span className="s4">bersertifikat ISO 9000 Tahun 2008</span>
              </p>
            </td>
          </tr>
          <tr style={{ height: "14pt" }}>
      ...
      <ol id="l17">
        <ol id="l18">
          <li data-list-text="6.1.">
            ...
            >
              Penyerahan Saprotan dilakukan di lahan budidaya yang dinyatakan
          ...
          <li data-list-text="6.2.">
            ...
            >
              ...
              <i>Delivery Order </i>(surat jalan) yang berlaku sebagai bukti
              serah terima Saprotan.
            </p>
          </li>
          <li data-list-text="6.3.">
            ...
            >
              Penyerahan Saprotan menandai peralihan kepemilikan dan tanggung
              jawab atas Saprotan dari BISI kepada Petani.
            </p>
          </li>
        </ol>
      </ol>
      ...
      <ol id="l19">
        <ol id="l20">
          <li data-list-text="7.1.">
            ...
            >
              Petani wajib menyiapkan lahan budidaya sesuai petunjuk-petunjuk
              BISI agar lahan menjadi siap tanam.
            </p>
          </li>
          ...
          <li data-list-text="7.3.">
            ...
            >
              BISI sewaktu-waktu dapat memasuki lahan budidaya untuk memastikan
              pelaksanaan budidaya yang baik dan memberikan petunjuk-petunjuk
              teknis pelaksanaan budidaya.
            </p>
          </li>
          <li data-list-text="7.4.">
            ...
            >
              CPI diperbolehkan untuk turut melakukan peninjauan apabila CPI
              ingin mengetahui kondisi jagung yang ditanam oleh Petani atas
      ...
      <ol id="l21">
        <ol id="l22">
          <li data-list-text="8.1.">
            ...
            >
              Petani akan memberikan akses data dan informasi panen; meliputi
              lokasi panen, luas lahan panen, dan estimasi tonase hasil panen,
              kepada BISI dan CPI.
            </p>
          </li>
          <li data-list-text="8.2.">
            ...
            >
              Berdasarkan data dan informasi panen yang diperoleh sebagaimana
              dimaksud dalam Pasal 8.1, pada usia budidaya ke-100 hari, staf
              administrasi BISI menerbitkan Laporan Rencana Panen (LRP) dan
              Surat Informasi Panen (SIP), dan menyampaikannya kepada Petani.
            </p>
          </li>
          <li data-list-text="8.3.">
            ...
            >
              Panen jagung hasil budidaya Petani dilakukan secara mekanis pada
              usia budidaya ke-120 hari, dan selanjutnya dilakukan penanganan
              pasca-panen.
            </p>
          </li>
        </ol>
      ...
      <ol id="l23">
        <ol id="l24">
          ...
          <li data-list-text="9.2.">
            ...
            >
              Harga jagung berlaku sesuai dengan spesifikasi mutu, harga pada
          ...
          <li data-list-text="9.3.">
            ...
            >
              Dalam hal pembelian jagung petani, Pihak CPI memberikan jaminan
              harga terendah Rp 3.500/kg jagung dengan KA 15%, sehingga apabila
              harga di pasar dibawah Rp 3.500/kg, maka harga yang digunakan
              adalah harga jaminan terendah.
            </p>
          </li>
        </ol>
      </ol>
      ...
      <ol id="l25">
        <ol id="l26">
          <li data-list-text="10.1.">
            ...
            >
              Masing-masing dari Para Pihak wajib memenuhi kewajiban-kewajiban
      ...
      <p style={{ paddingLeft: "11pt", textIndent: "0pt", textAlign: "left" }}>
        Perjanjian ini tunduk dan ditafsirkan berdasarkan hukum Negara Republik
        Indonesia.
      </p>
      <h2
        style={{
      ...
      <p
        style={{ paddingLeft: "11pt", textIndent: "0pt", textAlign: "justify" }}
      >
        Para Pihak memahami sepenuhnya bahwa yang dimaksud dengan BISI meliputi
        pimpinan, pegawai, karyawan, dan/atau wakil-wakil yang sah dari BISI;
        demikian pula halnya yang dimaksud dengan CPI meliputi pimpinan,
        pegawai, karyawan/staf, dan/atau wakil-wakil yang sah dari CPI. Yang
        dimaksud dengan Petani meliputi Petani, pemilik lahan budidaya, pekerja
        budidaya, ahli waris pemilik lahan, dan wakil-wakil yang sah dari Petani
        dan/atau pemilik lahan budidaya.
      </p>
      <h2
        style={{
          paddingTop: "10pt",
      ...
      <ol id="l27">
        <ol id="l28">
          ...
          <li data-list-text="13.2.">
            ...
            >
              Para Pihak menegaskan dan menyatakan bahwa masing-masing Pihak
              merupakan badan hukum/pribadi hukum atau entitas yang terpisah
              sehingga tindakan atau perbuatan salah satu dari Para Pihak
              merupakan tanggung jawab Pihak itu sendiri, dan bukan tanggung
              jawab Pihak lainnya.
            </p>
          </li>
        </ol>
      ...
      <ol id="l29">
        <ol id="l30">
          <li data-list-text="14.1.">
            ...
            >
              Petani dengan ini menyatakan bahwa Petani akan mematuhi Perjanjian
              ini, dan bahwa perbuatan-perbuatan Petani yang di luar ketentuan
              Perjanjian ini merupakan tanggung jawab Petani sendiri, dan dengan
              ini membebaskan BISI dan CPI dari tanggung jawab, baik pidana
              maupun perdata, serta dari segala kerugian yang mungkin timbul
              dari perbuatan-perbuatan Petani.
            </p>
          </li>
      ...
      <p
        style={{ paddingLeft: "11pt", textIndent: "0pt", textAlign: "justify" }}
      >
        Apabila dalam pelaksanaan Perjanjian ini terjadi perbedaan penafsiran
        terhadap ketentuan-ketentuan Perjanjian ini dan/ataupun timbul sengketa
        dalam pelaksanaannya, Para Pihak dengan ini bersepakat untuk
        bermusyawarah mencari penyelesaian; tetapi apabila cara tersebut tidak
        dapat ditempuh atau tidak mencapai kesepakatan penyelesaian, maka Para
        Pihak akan menyelesaikannya melalui Pengadilan Negeri Kabupaten
        Sidoarjo.
      </p>
      <h2
        style={{
      ...
      <ol id="l31">
        <ol id="l32">
          <li data-list-text="16.1.">
            ...
            >
              Kerjasama Usaha Pertanian dan Pengikatan Jual Beli Jagung ini
              tidak dapat diakhiri lebih dahulu sebelum berakhir menurut Jangka
              Waktu Kerjasama dan Pengikatan Jual Beli, namun dapat diperpanjang
              dengan syarat-syarat dan ketentuan-ketentuan yang disepakati oleh
              Para Pihak.
            </p>
          </li>
          <li data-list-text="16.2.">
            ...
            >
              Pengakhiran kerjasama secara sepihak oleh Petani memberikan hak
              kepada BISI untuk menuntut pelunasan atau pembayaran segala
      ...
      <ol id="l33">
        <ol id="l34">
          <li data-list-text="17.1.">
            ...
            >
              Jika terjadi keadaan memaksa (<i>force majeure</i>), Petani wajib
      ...
      >
        berkaitan langsung dengan keberlangsungan usaha budidaya pertanian dan
        pengikatan jual beli, dan lain-lain, yang semuanya secara langsung
        mempengaruhi atau berdampak pada kerjasama usaha pertanian dan
        pengikatan jual beli berdasarkan Perjanjian ini.
      </p>
      <p style={{ textIndent: "0pt", textAlign: "left" }}>
        <br />
      </p>
      ...
      <ol id="l35">
        <ol id="l36">
          <li data-list-text="18.1.">
            ...
            >
              Perjanjian ini merupakan keseluruhan kesepakatan Para Pihak dan
              mengatasi semua kesepakatan terdahulu oleh Para Pihak, baik secara
              tertulis maupun secara lisan, mengenai hal-hal yang disepakati
          ...
          <li data-list-text="18.2.">
            ...
            >
              Apabila di kemudian hari ada suatu ketentuan dalam Perjanjian ini
              menjadi tidak sesuai dengan peraturan perundang-undangan yang
              berlaku atau menjadi tidak berlaku karena hukum, maka
              ketentuan-ketentuan lain tetap berlaku dan mengikat Para Pihak
              sebagaimana mestinya, dan dalam hal demikian, Para Pihak akan
              segera berunding untuk membahas ketentuan yang tidak berlaku
              tersebut.
            </p>
          </li>
          <li data-list-text="18.3.">
            ...
            >
              Hal-hal yang belum atau belum cukup diatur dalam Perjanjian ini,
              akan diatur berdasarkan kesepakatan tertulis Para Pihak dalam
          ...
          <li data-list-text="18.4.">
            ...
            >
              Lampiran-lampiran Perjanjian ini dapat diubah atau disesuaikan
              dari waktu ke waktu tanpa mempengaruhi keberlakuan Perjanjian ini.
            </p>
          </li>
          <li data-list-text="18.5.">
            ...
            >
              Lampiran, addendum, amandemen, ataupun ketentuan-ketentuan yang
              ditetapkan berdasarkan Perjanjian ini merupakan bagian yang tidak
            ...
            >
              PT BISI International, Tbk. Petani, PT Charoen Pokphand Indonesia,
              Tbk.
            </p>
            <p style={{ textIndent: "0pt", textAlign: "left" }}>
              <br />
            ...
            >
              ...
              Jagung Nomor: <span className="h1">…………………………………..</span>
            </p>
            <h3
              style={{
                paddingLeft: "11pt",
            ...
            >
              ...
              tanggal <span className="s9">…………………. </span>sampai dengan panen
              yang diestimasi pada tanggal
            </p>
            <p
              className="s9"
              style={{
            ...
            >
              Perjanjian Kerjasama Usaha Pertanian Dan Pengikatan Jual Beli
              Jagung Nomor: <span className="s9">…………………………………...</span>
            </p>
            <h3
              style={{
                paddingTop: "10pt",
            ...
            <table
              style={{ borderCollapse: "collapse", marginLeft: "12.509pt" }}
              cellSpacing={0}
            >
              <tbody>
            ...
            >
              Catatan: Jenis dan Harga Saprotan dapat berubah sewaktu-waktu
            ...
            <ol id="l37">
              ...
              <li data-list-text={3}>
                ...
                >
                  Jarak Tanam : 75 x 25 cm dengan jumlah benih 1 (satu) atau 2
                  (dua) biji per lubang
                </p>
              </li>
              <li data-list-text={4}>
              ...
              <li data-list-text={6}>
                ...
                <table
                  style={{ borderCollapse: "collapse", marginLeft: "54.186pt" }}
                  cellSpacing={0}
                >
                  <tbody>
      ...
      <div className="mt-6 flex justify-end gap-x-3 mr-48">
        <a
