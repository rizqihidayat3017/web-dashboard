        ...
        <table className="w-full justify-items-center text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
              ...
              <th scope="col" className="px-6 py-3">
                Tanam dan Pemupukan Dasar
              </th>
            </tr>
          </thead>
          <tbody>
            {cycle2.map((cycledua, index) => (
              <tr
                key={index}
              ...
              >
                ...
                <td className="px-6 py-4">
                  <span className="relative inline-block px-3 py-1 font-semibold text-green-900 leading-tight">
                    ...
                    />
                    <span className="relative text-xs">{cycledua.status}</span>
                  </span>
                </td>
                <td className="px-6 py-4">{cycledua.noContract}</td>
                <td className="px-6 py-4">{cycledua.luasArea}</td>
                <td className="px-6 py-4">
                  <Link to={cycledua.linkDetails}>
