function Petanidetails() {
  ...
  return (
    <div className="overflow-x-auto shadow-md sm:rounded-lg">
      <div className="w-full py-4 overflow-hidden bg-white shadow-lg px-4 sm:px-12">
        <div className="flex justify-between">
          <div className="w-full md:w-1/2 lg:w-7/12 border rounded px-2 lg:px-6 h-12 bg-transparent">
            <div className="flex items-stretch w-full h-full relative">
              <div className="flex items-center leading-normal bg-transparent rounded rounded-r-none border border-r-0 border-none lg:px-3 py-2 whitespace-no-wrap text-gray-500">
                <svg
                  width={18}
                  height={18}
              ...
              <input
                type="text"
                className="flex-shrink flex-grow flex-auto leading-normal tracking-wide w-px flex-1 border border-none border-l-0 rounded rounded-l-none px-3 relative focus:outline-none text-sm text-gray-500 font-thin"
                placeholder="Search"
              />
            </div>
          </div>
