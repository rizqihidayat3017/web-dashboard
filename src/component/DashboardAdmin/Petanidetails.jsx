        ...
        <tbody>
          {data.map((item, index) => (
            ...
            >
              ...
              <td className="px-6 py-4">{item.noCGR}</td>
              <td className="px-6 py-4">{item.noContract}</td>
              <td className="px-6 py-4">{item.namaPetani}</td>
              <td className="px-6 py-4">{item.varietas}</td>
              <td className="px-6 py-4">{item.luasLahan}</td>
              <td className="px-6 py-4">{item.lokasi}</td>
              <td className="px-6 py-4">{item.planningTanam}</td>
